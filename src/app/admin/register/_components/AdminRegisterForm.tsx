  ...
  return (
    <AuthCard>
      <AuthHeader
        ...
        subtitle="Create an AuthPlug account to manage your users"
      />
      ...
      >
        <form onSubmit={handleDetails} className="flex flex-col gap-4">
          <div className="flex items-center gap-2.5 p-3.5 bg-neutral-50 rounded-xl border border-neutral-200">
            ...
            <p className="text-sm text-neutral-500">
              Your company ID will be shown after registration. Keep it safe — it is required for SDK integration.
            </p>
          </div>
        ...
        <p className="mt-6 text-center text-sm text-neutral-400">
          Already registered?{" "}
          <a href="/admin/login" className="text-brand-600 font-medium hover:underline">
            Sign in
          </a>
        </p>
      </Transition>
